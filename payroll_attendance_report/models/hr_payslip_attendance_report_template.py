...
class HrPayslipAttendanceReportTemplate(models.Model):
    _name = "hr.payslip.attendance.report.template"
    _description = "Payslip Attendance Report Template"
    _order = "name"
    ...
    report_template_id = fields.Many2one(
        ...
        domain=[("type", "=", "qweb"), ("key", "like", "payroll_attendance_report.%")],
        required=True,
        ondelete="restrict",
    )
    ...
    def action_duplicate(self):
        ...
        return {
            ...
            "name": _("Attendance Template"),
            "res_model": "hr.payslip.attendance.report.template",
